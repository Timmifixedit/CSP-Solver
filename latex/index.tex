Project for the lecture \char`\"{}\+Objektorientierte Programmierung mit C++\char`\"{} at Ulm University. Solves arbitrary binary constraint satisfaction problems (C\+SP) using the \href{https://en.wikipedia.org/wiki/AC-3_algorithm}{\texttt{ A\+C-\/3 algorithm}} and backtracking search.\hypertarget{index_autotoc_md1}{}\doxysubsection{Doxygen Documentation}\label{index_autotoc_md1}
